...
-- -----------------------------------------------------
-- Table `secure_hood`.`usuario-grupo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `secure_hood`.`usuario-grupo` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `secure_hood`.`usuario-mensagem`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `secure_hood`.`usuario-mensagem` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `usuario_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `secure_hood`.`mensagem-grupo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `secure_hood`.`mensagem-grupo` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `mensagem_id` INT NOT NULL,
  `grupo_id` INT NOT NULL,
  PRIMARY KEY (`id`),
