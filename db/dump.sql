...
DROP TABLE IF EXISTS `mensagem_grupo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
LOCK TABLES `mensagem_grupo` WRITE;
/*!40000 ALTER TABLE `mensagem_grupo` DISABLE KEYS */;
/*!40000 ALTER TABLE `mensagem_grupo` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `mensagem_usuario`
--

LOCK TABLES `mensagem_usuario` WRITE;
/*!40000 ALTER TABLE `mensagem_usuario` DISABLE KEYS */;
/*!40000 ALTER TABLE `mensagem_usuario` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `usuario_grupo` (
  ...
  `membroAceito` varchar(3) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2018-04-16  2:05:52
